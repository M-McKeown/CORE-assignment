...
#----------------------------------------------------
Column1<-Data[1]/sum(Data[1]) #Only 4 columns so we just have to do this four times
...
names(Proportions)<-c("Adenine","Guanine","Cytosine","Thymine") #None of columns have headers so we can create our own  for each of the 4 columns
#----------------------------------------------------
